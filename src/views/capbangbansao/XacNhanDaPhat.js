...
import { XacNhanDaPhatBanSao } from 'services/capbangbansaoService';
...
const XacNhanDaPhat = () => {
  ...
  const hanldeXacNhanIn = async () => {
    ...
    try {
      let response = await XacNhanDaPhatBanSao(hocsinh_madon.id);
  ...
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <MuiTypography variant="h4" gutterBottom m={2}>
        {t(`Bạn có muốn xác nhận đã phát bản sao của [${hocsinh_madon.hocSinh.hoTen}] ?`)}
      </MuiTypography>
