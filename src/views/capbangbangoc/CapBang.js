...
import { openPopupSelector, openSubPopupSelector, selectedDanhmucSelector, selectedDonvitruongSelector } from 'store/selectors';
...
import { getListHocSinhDuaVaoSoGoc } from 'services/capbangbanchinhService';

const CapBang = ({ dataCCCD }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const response = await getListHocSinhDuaVaoSoGoc(params, data);
