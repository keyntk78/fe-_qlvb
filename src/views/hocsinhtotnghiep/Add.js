...
import { createHocSinh } from 'services/nguoihoctotnghiepService';
    ...
    <form onSubmit={formik.handleSubmit}>
      <Grid container>
        ...
        <Grid xs={12} item container spacing={isXs ? 0 : 2} columnSpacing={isXs ? 1 : 0}>
          ...
          <InputForm1 formik={formik} xs={isXs ? 6 : 3} label={t('hocsinh.field.bdate')} name="ngaySinh" isRequired type="date" />
          {/* <InputForm1 formik={formik} xs={isXs ? 6 : 3} label={t('hocsinh.field.nation')} name="danToc" isRequired /> */}
          <Grid item xs={isXs ? 6 : 3}>
            <FormControlComponent xsLabel={0} xsForm={12} isRequire label={t('hocsinh.field.nation')}>
              <FormControl fullWidth variant="outlined">
                <SelectForm
                  formik={formik}
                  keyProp="ten"
        ...
        <Grid xs={12} item container spacing={isXs ? 0 : 2} mt={0} columnSpacing={isXs ? 1 : 0}>
          ...
          <Grid item xs={isXs ? 6 : 3}>
            <FormControlComponent xsLabel={0} xsForm={12} isRequire label={t('rating')}>
              <FormControl fullWidth variant="outlined">
                <SelectForm
                  formik={formik}
                  keyProp="value"
        ...
        <Grid xs={12} item container spacing={isXs ? 0 : 2}>
          ...
          <Grid item xs={isXs ? 12 : 4}>
            <FormControlComponent xsLabel={0} xsForm={12} isRequire label={t('khoathi.title')}>
              <FormControl fullWidth variant="outlined">
                <SelectForm
                  formik={formik}
                  convert
