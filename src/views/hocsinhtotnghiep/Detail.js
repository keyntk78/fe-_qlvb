    ...
    <form onSubmit={formik.handleSubmit}>
      <Grid container>
        ...
        <Grid xs={12} item container spacing={2} mt={0}>
          ...
          <InputForm1 formik={formik} xs={isXs ? 6 : 3} label={t('Lớp')} name="lop" isRequired isDisabled />
          <InputForm1 formik={formik} xs={isXs ? 6 : 3} label={t('Hội đồng thi')} name="hoiDong" isRequired isDisabled />
        </Grid>
        <Grid xs={12} item container spacing={2}>
